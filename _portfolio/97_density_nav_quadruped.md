...
This project incorporates the density formulation from the following [paper](https://ieeexplore.ieee.org/abstract/document/10238751) submitted to Robotics Automations and Letters (RA-L), titled "Safe Navigation Using Density Functions" onto quadrupeds.
